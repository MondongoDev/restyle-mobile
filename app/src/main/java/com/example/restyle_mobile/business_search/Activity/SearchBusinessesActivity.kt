...
class SearchBusinessesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        projectService = retrofit.create<ProjectService>(ProjectService::class.java)
        //getAllProjects()
    }
    ...
    /*private fun getAllProjects(){
        projectService.getProjects().enqueue(object : Callback<List<Project>>{
            override fun onResponse(p0: Call<List<Project>>, p1: Response<List<Project>>) {
                val project = p1?.body()
                ...
                if(project != null){
                    ...
                    val recycler = findViewById<RecyclerView>(R.id.projectRecyclerView)
                    recycler.layoutManager = LinearLayoutManager(applicationContext)
                    recycler.adapter = ProjectAdapter(listProjects)
                }
            }
            override fun onFailure(p0: Call<List<Project>>, p1: Throwable) {
                p1.printStackTrace()
            }
        })
    }*/
